@section('content')
<p>
    <a class="btn btn-primary" href="{{url('menus/create')}}" data-toggle="modal" data-target="#addModal">Add menu</a>
</p>

<!-- In a conventional manner , a small amount of data are available -->
  ...
  <table class="table table-bordered table-hover" id="table2">
      ...
      <tbody>
            ...
            <tr>
                ...
                <?php //if (is_super_admin()){?>
            	<td>
                    <a href="{{url('menus/' . $meau['id'], 'edit')}}" data-toggle="modal" data-target="#editModal"><i class="fa fa-pencil"></i></a>
      ...
      "fnDrawCallback" : function(){
        ...
        $("select").chosen({
  	    ...
  	    jQuery('.delete-row').click(function(){
      	    ...
      	    var deleteurl = "{{url('menus')}}" + "/" + $this.attr('rel');
      	        $.ajax({
      	    	    url: deleteurl,
        	    	dataType: 'json',
    	    	    type: 'DELETE'
